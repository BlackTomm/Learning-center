...
public interface CoffeeMapper {
    ...
    @Insert({
            ...
            "values (#{name,jdbcType=VARCHAR}, #{price,jdbcType=BIGINT,typeHandler=spring.data.typehandler.MoneyTypeHandler}, ",
    ...
    @ResultMap("spring.data.mapper.CoffeeMapper.BaseResultMap")
    ...
    @Update({
            ...
            "PRICE = #{price,jdbcType=BIGINT,typeHandler=spring.data.typehandler.MoneyTypeHandler},",
