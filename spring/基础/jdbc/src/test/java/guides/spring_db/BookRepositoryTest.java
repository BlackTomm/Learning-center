package guides.spring_db;

import guides.spring_db.config.DataSourceConfig;
...
public class BookRepositoryTest {
    ...
    public void testFindBook(){
        Book book=bookRepository.findBook(6L);
        Assert.assertNotNull(book);
        Assert.assertEquals(book.getBookName(),"RabbitMQ实战指南");
    }
}
